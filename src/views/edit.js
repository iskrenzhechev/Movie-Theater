import { editTheater, getTheaterId } from '../api/data.js';
import { html } from '../lib.js';

const editTemplate = (theater, onSumbit) => html`
<section @submit=${onSumbit} id="editPage">
...
export async function editPage(ctx) {
    ...
    ctx.render(editTemplate(theater, onSumbit));
